 ...
 */
public class GameHard extends Activity {
    private ImageButton myImageButton0, myImageButton1, myImageButton2, myImageButton3, myImageButton4, myImageButton5, myImageButton6, myImageButton7, myImageButton8, myImageButton9, myImageButton10, myImageButton11, myImageButton12, myImageButton13, myImageButton14, myImageButton15;
    ...
    private void selectCardButton(int cardIndex) {
        ...
        if (card1 == cardIndex) {
            ...
            card2 = cardIndex;
            for (int i = 15; i >= 0; i--) {
                imageButtons[i].setEnabled(false);   // 클릭 무효화
            }
            Handler h = new Handler();
            h.postDelayed(new splashhandler(), 450);// 지연
    ...
    class splashhandler implements Runnable {
        public void run() {
            for (int i = 15; i >= 0; i--) {
                imageButtons[i].setEnabled(true);   // 클릭 유효화
            }
        }
    }
