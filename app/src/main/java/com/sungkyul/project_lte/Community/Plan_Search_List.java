...
// 여행 계획 검색 List 페이지
public class Plan_Search_List extends AppCompatActivity {
    TextView txt_searchWord; // 검색 단어 표시
    Button btn_back; // 뒤로가기 버튼
    private ListView list_plan_search; // 검색 단어에 맞는 글 목록 표시 리스트 뷰

    String tag = "searchPlan", word, res, search, country, tag2 = "searchCountryPlan";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plan__search__list);
        ...
        if(search.equals("1")) {
            ...
            dialog = ProgressDialog.show(Plan_Search_List.this, "", "로딩중...", true);
    ...
    private AdapterView.OnItemClickListener FreeBoardRead = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent intent_read_free = new Intent(Plan_Search_List.this, Plan_Board_Read.class);
    ...
    void searchCountry() {
        try {
            ...
            if (success.equals("1")) {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ListAdapter adapter = new Plan_Search_Adapter(Plan_Search_List.this, R.layout.plan_search_item_row, list);
    ...
    void searchPlan() {
        try {
            ...
            if (success.equals("1")) {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ListAdapter adapter = new Plan_Search_Adapter(Plan_Search_List.this, R.layout.free_search_item_row, list);
                        list_plan_search.setAdapter(adapter);
                    }
                });
            } else {
    ...
    public void showAlert() {
        Plan_Search_List.this.runOnUiThread(new Runnable() {
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder(Plan_Search_List.this);
