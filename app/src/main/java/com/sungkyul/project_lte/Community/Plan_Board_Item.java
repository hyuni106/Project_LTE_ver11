...
public class Plan_Board_Item {
    ...
    public Plan_Board_Item(){
        super();
    }

    // Plan_Board_Item 생성자 매개변수
    public Plan_Board_Item(String num, String title, String name, String date, String look, String like){
        super();
        this.num = num;
        this.title = title;
        this.name = name;
