 ...
 */
// 여행 후기 글 읽기 모듈 List Item
public class Trip_Read_Module_Item {
    public String place; // 모듈 장소
    public String content; // 모듈 장소 설명
    public String position; // 모듈 위치
    public String no; // 모듈 번호

    public Trip_Read_Module_Item(){
        super();
    }

    // Trip_Read_Module_Item 생성자 매개변수
    public Trip_Read_Module_Item(String place, String content, String position, String no){
        super();
        this.place = place;
